export default function footer() {
            ...
            <div class="spc-social spc-social-b ">
                    ...
                    <a href="#" class="link s-youtube" target="_blank" rel="noopener">
                        ...
                        <span class="visuallyhidden">YouTube</span>
                            ...
                            <div class="links">
                                <div class="menu-footer-links-container"><ul id="menu-footer-links" class="menu"><li id="menu-item-352" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-home current-menu-item page_item page-item-6 current_page_item menu-item-352"><a href="https://smartmag.theme-sphere.com/sports/" aria-current="page">Home</a></li>
    ...
    <li id="menu-item-356" class="menu-item menu-item-type-custom menu-item-object-custom menu-item-356"><a href="#">Get In Touch</a></li>
                    ...
                    <div class="copyright">
                        &copy; 2021 ThemeSphere. Designed by <a href="https://theme-sphere.com">ThemeSphere</a>.				</div>
                </div>
            </div>		
                </footer>
    </>
